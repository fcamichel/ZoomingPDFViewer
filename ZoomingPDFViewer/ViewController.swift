...
class ViewController: UIViewController, UIPageViewControllerDelegate {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, spineLocationFor orientation: UIInterfaceOrientation) -> UIPageViewControllerSpineLocation {
        ...
        if (indexOfCurrentViewController == 0 || indexOfCurrentViewController % 2 == 0) {
            ...
            let previousViewController: UIViewController = self.modelController.pageViewController(self.pageViewController, viewControllerBefore: currentViewController)!
